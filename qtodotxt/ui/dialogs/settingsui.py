...
class Ui_SettingsUI(object):
    def setupUi(self, SettingsUI):
        ...
        self.addJiraCheckBox = QtWidgets.QCheckBox(self.groupBox)
        self.addJiraCheckBox.setChecked(True)
        self.addJiraCheckBox.setObjectName("supportJira")
        self.gridLayout.addWidget(self.addJiraCheckBox, 6, 0, 1, 1)
    ...
    def retranslateUi(self, SettingsUI):
        ...
        self.addJiraCheckBox.setText(_translate("SettingsUI", "Replace link to Jira with id"))
