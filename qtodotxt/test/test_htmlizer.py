...
class TestHtmlizer(unittest.TestCase):
    ...
    def test_06(self):
        ...
        self.assertEqual(self.htmlizer.task2html(task),
        '<tt>&nbsp;&nbsp;&nbsp;</tt>this is my task <font color="green">@context</font> and <font style="color:#64AAD0">+project</font> and some more words')
    ...
    def test_13(self):
        ...
        self.assertEqual(self.htmlizer.task2html(task),
        '<tt>&nbsp;&nbsp;&nbsp;</tt>this is my task <b><font style="color:red">*** Invalid date format, expected: YYYY-mm-dd! t:2014-04 ***</font></b>')
