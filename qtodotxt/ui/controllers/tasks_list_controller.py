...
class TasksListController(QtCore.QObject):
    ...
    def _initEditTaskAction(self):
        action = QtGui.QAction(getIcon('TaskEdit.svg'), '&Edit Task', self)
    ...
    def _initCreateTaskAction(self):
        action = QtGui.QAction(getIcon('TaskCreate.svg'), '&Create New Task', self)
    ...
    def _initDeleteSelectedTasksAction(self):
        action = QtGui.QAction(getIcon('TaskDelete.svg'), '&Delete Selected Tasks', self)
    ...
    def _initCompleteSelectedTasksAction(self):
        action = QtGui.QAction(getIcon('TaskComplete.svg'), 'C&omplete Selected Tasks', self)
    ...
    def _initDecreasePrioritySelectedTasksAction(self):
        action = QtGui.QAction(getIcon('TaskPriorityDecrease.svg'), 'Decrease Priority', self)
        action.setShortcuts(['-', '<'])
    ...
    def _initIncreasePrioritySelectedTasksAction(self):
        action = QtGui.QAction(getIcon('TaskPriorityIncrease.svg'), 'Increase Priority', self)
        action.setShortcuts(['+', '>'])
