...
class Ui_SettingsUI(object):
    ...
    def retranslateUi(self, SettingsUI):
        SettingsUI.setWindowTitle(QtGui.QApplication.translate(
            "SettingsUI", "SettingsUI", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox.setTitle(QtGui.QApplication.translate(
            "SettingsUI", "QTodoTxt Settings", None, QtGui.QApplication.UnicodeUTF8))
        self.autoSaveCheckBox.setText(QtGui.QApplication.translate(
            "SettingsUI", "Autosave", None, QtGui.QApplication.UnicodeUTF8))
        self.autoArchiveCheckBox.setText(QtGui.QApplication.translate(
            "SettingsUI", "AutoArchive", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label.setText(QtGui.QApplication.translate(
            "SettingsUI", "Lowest task priority", None, QtGui.QApplication.UnicodeUTF8))
        self.lowestPriorityLineEdit.setText(QtGui.QApplication.translate(
            "SettingsUI", "D", None, QtGui.QApplication.UnicodeUTF8))
        self.closeButton.setText(QtGui.QApplication.translate(
            "SettingsUI", "Close", None, QtGui.QApplication.UnicodeUTF8))
